#!/usr/bin/env python3
"""
Generate KiCad 9.0 schematics with CORRECT symbol names from standard libraries
"""
...
def gen_power_sch():
  ...
  (symbol (lib_id "Regulator_Linear:LM7805_TO220") (at 90 50 0) (uuid "pwr-u1")
...
def gen_digital_sch():
  ...
  (symbol (lib_id "Connector_Generic:Conn_02x10_Odd_Even") (at 35 60 0) (uuid "dig-j2")
...
def gen_analog_sch():
  ...
  (symbol (lib_id "Amplifier_Operational:OPA690xD") (at 200 70 0) (uuid "ana-u6")
    (property "Reference" "U6" (at 192.38 78.62 0)
      (effects (font (size 1.27 1.27)))
    )
    (property "Value" "OPA690" (at 200 70 0)
      (effects (font (size 1.27 1.27)))
    )
...
def main():
    ...
    print("\n✅ KiCad 9.0 files generated with CORRECT symbol names")
    print("\nSymbol corrections:")
    print("  - Conn_02x10 → Connector_Generic:Conn_02x10_Odd_Even")
    print("  - LM7805-5V0 → Regulator_Linear:LM7805_TO220")
    print("  - OPA657 → Amplifier_Operational:OPA690xD (alternative high-speed op-amp)")
